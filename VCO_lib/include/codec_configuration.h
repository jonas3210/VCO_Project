/**
******************************************************************************
  * @file    codec_configuration.h
  * @author  Frieder Jespers
  * @version V.0.0
  * @date    01/09/2016
  * @brief   This file contains the headers of Codec Configuration
  ******************************************************************************
  * @copy
*/
/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __CODEC_CONFIGURATION_H
#define __CODEC_CONFIGURATION_H
...
#define CODEC_I2C_ADDRESS 0x94//Write-Mode for Codec
...
/* Exported functions ------------------------------------------------------- */
void codec_Init(void);//Initialize Hardware for Codec Communication
void send_Codec_Config(uint8_t config_Bytes[],uint8_t byte_Amount);//Sends Configbytes to Codec
void codec_Configuration(void);//Sends whole Codec Configuration
void codec_DMA_Init(void);
uint8_t receive_Codec_Data(uint8_t map_Byte);//receive Data-Byte from Codec
#endif /*__CODEC_CONFIGURATION_H */
